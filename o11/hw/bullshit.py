...
PART1 = ["Erõforrás-alapú megközelítéssel kell",
...
PART3 = ["a közösségi normáknak megfelelõ", 
"a decentralizált", 
...
def get_bullshit():
    return random.choice(PART1) + ' ' + random.choice(PART2) + ' ' + random.choice(PART3) + ' ' + random.choice(PART4)
